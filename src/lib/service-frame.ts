...
export const SERVICE_SLUGS = new Set([
  ...
  "mini-valet",
  "zeus-full-valet",
  "triton-premium-interior-valet",
  "deep-clean-full-valet",
  "ultimate-pre-sale-valet",
  "summer-glow-valet",
  "winter-protection",
  "mould-sanitisation-sterilisation-service",
  "soft-top-reproofing",
  // Detailing
  "detailing",
  "new-car-protection",
  "mini-car-detail-in-london",
  "enhancement",
  "correction",
  "perfection",
  "wheeluv",
  ...
  "car-paint-spillage-removal-service",
  "safely-clean-sickness-vomit-from-your-car-interior",
  "car-graffiti-removal",
  "car-flooding-and-water-damage-repair",
  "car-van-stickers-removal",
  "car-leather-seats-cleaning-conditioning-and-protection",
  "car-windscreen-protection",
  "caravan-valeting",
  "autoglymwax",
  "pet-hair-removal",
